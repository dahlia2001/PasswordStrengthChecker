...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      ?>
      <input type="text" name="name" required placeholder="enter your name" class="use-keyboard-input">
      ...
      <input type="password" name="cpassword" required placeholder="confirm your password" class="use-keyboard-input">
